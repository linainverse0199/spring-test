...
/*
HomeControllerTest is annotated with @WebMvcTest. This
...
More specifically, in this case, it arranges for
...
public class HomeControllerTest {
    ...
    /*
    The test class is injected with a MockMvc object for the test to drive the
mockup.
     */
    ...
    public void testHomePage() throws Exception {
        /*
        It starts with the MockMvc object to perform an HTTP GET request for /
(the root path).
         */
        mockMvc.perform(get("/"))
